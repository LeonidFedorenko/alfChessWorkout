...
namespace alfChessWorkout
{
    ...
    {   // картинка из PNG (все фигуры)
        ...
        {   // форма для 1 этюда
            ...
            this.Text = " Этюд №2. Мат в один ход. Ход белых.";
            // загрузка фигур для этюда №2
            Init();
        }

        public void showTask02_click(object sender, EventArgs e)
        {
            if (pictureBox2.Visible == true)
            {
                pictureBox2.Visible = false; // скрываю рисунок (с задачей)
                buttonTask02.Text = "   ОБНОВИТЬ       ДАННЫЙ   ЭТЮД";
            }
            else
            {   // перезапуск этюда
                this.Controls.Clear();
        ...
        {   // кнопка не нажата - фон стандартный
            ...
            if ((userSteps == 1) && (pressedButton.Location.X == 174) && (pressedButton.Location.Y == 50) && (chessboard[0, 1] == 0))
            {
                labelTask02.ForeColor = Color.GreenYellow;
                labelTask02.Text = "Вы успешно решили Этюд №2.";
                MessageBox.Show("Вы успешно решили Этюд №2.", "Обновить Этюд №2", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                labelTask02.ForeColor = Color.OrangeRed;
                labelTask02.Text = "Решить за 1 ход не удалось.";
            }
