...
namespace alfChessWorkout
{
    ...
    {   // картинка из PNG (все фигуры)
        ...
        {   // форма для 38 этюда
            ...
            this.Text = " Этюд №38. Мат в один ход. Ход белых.";
            // загрузка фигур для этюда №38
            Init();
        }

        public void showTask38_click(object sender, EventArgs e)
        {
            if (pictureBox1.Visible == true)
            {
                pictureBox1.Visible = false; // скрываю рисунок (с задачей)
                buttonTask38.Text = "   ОБНОВИТЬ       ДАННЫЙ   ЭТЮД";
            }
            else
            {   // перезапуск этюда
                this.Controls.Clear();
        ...
        {   // кнопка не нажата - фон стандартный
            ...
            if ((userSteps == 1) && (pressedButton.Location.X == 422) && (pressedButton.Location.Y == 112) && (chessboard[2,5]==0))
            {
                labelTask38.ForeColor = Color.GreenYellow;
                labelTask38.Text = "Вы успешно решили Этюд №38.";
                MessageBox.Show("Вы успешно решили Этюд №38.", "Обновить Этюд №38", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                labelTask38.ForeColor = Color.WhiteSmoke;
                labelTask38.Text = "Решить за 1 ход не удалось.";
            }
