...
namespace alfChessWorkout
{
    ...
    {   // картинка из PNG (все фигуры)
        ...
        {   // форма для 7 этюда
            ...
            this.Text = " Этюд №7. Мат в один ход. Ход белых.";
            // загрузка фигур для этюда №7
            Init();
        }

        public void showTask07_click(object sender, EventArgs e)
        {
            if (pictureBox1.Visible == true)
            {
                pictureBox1.Visible = false; // скрываю рисунок (с задачей)
                buttonTask07.Text = "   ОБНОВИТЬ       ДАННЫЙ   ЭТЮД";
            }
            else
            {   // перезапуск этюда
                this.Controls.Clear();
        ...
        {   // кнопка не нажата - фон стандартный
            ...
            if ((userSteps == 1) && (pressedButton.Location.X == 360) && (pressedButton.Location.Y == 174) && (chessboard[3,5]==0))
            {
                labelTask07.ForeColor = Color.GreenYellow;
                labelTask07.Text = "Вы успешно решили Этюд №7.";
                MessageBox.Show("Вы успешно решили Этюд №7.", "Обновить Этюд №7", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                labelTask07.ForeColor = Color.WhiteSmoke;
                labelTask07.Text = "Решить за 1 ход не удалось.";
            }
