...
namespace alfChessWorkout
{
    ...
    {   // картинка из PNG (все фигуры)
        ...
        {   // форма для 24 этюда
            ...
            this.Text = " Этюд №24. Мат в один ход. Ход белых.";
            // загрузка фигур для этюда №24
            Init();
        }

        public void showTask24_click(object sender, EventArgs e)
        {
            if (pictureBox1.Visible == true)
            {
                pictureBox1.Visible = false; // скрываю рисунок (с задачей)
                buttonTask24.Text = "   ОБНОВИТЬ       ДАННЫЙ   ЭТЮД";
            }
            else
            {   // перезапуск этюда
                this.Controls.Clear();
        ...
        {   // кнопка не нажата - фон стандартный
            ...
            if ((userSteps == 1) && (pressedButton.Location.X == 112) && (pressedButton.Location.Y == 112) && (chessboard[7,1]==0))
            {
                labelTask24.ForeColor = Color.GreenYellow;
                labelTask24.Text = "Вы успешно решили Этюд №24.";
                MessageBox.Show("Вы успешно решили Этюд №24.", "Обновить Этюд №24", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                labelTask24.ForeColor = Color.WhiteSmoke;
                labelTask24.Text = "Решить за 1 ход не удалось.";
            }
