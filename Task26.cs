...
namespace alfChessWorkout
{
    ...
    {   // картинка из PNG (все фигуры)
        ...
        {   // форма для 26 этюда
            ...
            this.Text = " Этюд №26. Мат в один ход. Ход белых.";
            // загрузка фигур для этюда №26
            Init();
        }

        public void showTask26_click(object sender, EventArgs e)
        {
            if (pictureBox1.Visible == true)
            {
                pictureBox1.Visible = false; // скрываю рисунок (с задачей)
                buttonTask26.Text = "   ОБНОВИТЬ       ДАННЫЙ   ЭТЮД";
            }
            else
            {   // перезапуск этюда
                this.Controls.Clear();
        ...
        {   // кнопка не нажата - фон стандартный
            ...
            if ((userSteps == 1) && (pressedButton.Location.X == 484) && (pressedButton.Location.Y == 50) && (chessboard[7,7]==0))
            {
                labelTask26.ForeColor = Color.GreenYellow;
                labelTask26.Text = "Вы успешно решили Этюд №26.";
                MessageBox.Show("Вы успешно решили Этюд №26.", "Обновить Этюд №26", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                labelTask26.ForeColor = Color.WhiteSmoke;
                labelTask26.Text = "Решить за 1 ход не удалось.";
            }
