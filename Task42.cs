...
namespace alfChessWorkout
{
    ...
    {   // картинка из PNG (все фигуры)
        ...
        {   // форма для 1 этюда
            ...
            this.Text = " Этюд №42. Мат в один ход. Ход черных.";
            // загрузка фигур для этюда №1
            Init();
        }

        public void showTask42_click(object sender, EventArgs e)
        {
            if (pictureBox1.Visible == true)
            {
                pictureBox1.Visible = false; // скрываю рисунок (с задачей)
                buttonTask42.Text = "   ОБНОВИТЬ       ДАННЫЙ   ЭТЮД";
            }
            else
            {   // перезапуск этюда
                this.Controls.Clear();
        ...
        {   // кнопка не нажата - фон стандартный
            ...
            if ((userSteps == 1) && (pressedButton.Location.X == 50) && (pressedButton.Location.Y == 422) && (chessboard[0, 0] == 0))
            {
                labelTask42.ForeColor = Color.GreenYellow;
                labelTask42.Text = "Вы успешно решили Этюд №42.";
                MessageBox.Show("Вы успешно решили Этюд №42.", "Обновить Этюд №42", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                labelTask42.ForeColor = Color.OrangeRed;
                labelTask42.Text = "Решить за 1 ход не удалось.";
            }
