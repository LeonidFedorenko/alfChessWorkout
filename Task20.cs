...
namespace alfChessWorkout
{
    ...
    {   // картинка из PNG (все фигуры)
        ...
        {   // форма для 20 этюда
            ...
            this.Text = " Этюд №20. Мат в один ход. Ход белых.";
            // загрузка фигур для этюда №20
            Init();
        }

        public void showTask20_click(object sender, EventArgs e)
        {
            if (pictureBox1.Visible == true)
            {
                pictureBox1.Visible = false; // скрываю рисунок (с задачей)
                buttonTask20.Text = "   ОБНОВИТЬ       ДАННЫЙ   ЭТЮД";
            }
            else
            {   // перезапуск этюда
                this.Controls.Clear();
        ...
        {   // кнопка не нажата - фон стандартный
            ...
            if ((userSteps == 1) && (pressedButton.Location.X == 422) && (pressedButton.Location.Y == 174) && (chessboard[4,5]==0))
            {
                labelTask20.ForeColor = Color.GreenYellow;
                labelTask20.Text = "Вы успешно решили Этюд №20.";
                MessageBox.Show("Вы успешно решили Этюд №20.", "Обновить Этюд №20", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                labelTask20.ForeColor = Color.WhiteSmoke;
                labelTask20.Text = "Решить за 1 ход не удалось.";
            }
