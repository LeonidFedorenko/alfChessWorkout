...
namespace alfChessWorkout
{
    ...
    {   // картинка из PNG (все фигуры)
        ...
        {   // форма для 12 этюда
            ...
            this.Text = " Этюд №12. Мат в один ход. Ход белых.";
            // загрузка фигур для этюда №12
            Init();
        }

        public void showTask12_click(object sender, EventArgs e)
        {
            if (pictureBox1.Visible == true)
            {
                pictureBox1.Visible = false; // скрываю рисунок (с задачей)
                buttonTask12.Text = "   ОБНОВИТЬ       ДАННЫЙ   ЭТЮД";
            }
            else
            {   // перезапуск этюда
                this.Controls.Clear();
        ...
        {   // кнопка не нажата - фон стандартный
            ...
            if ((userSteps == 1) && (pressedButton.Location.X == 298) && (pressedButton.Location.Y == 236) && (chessboard[0,1]==0))
            {
                labelTask12.ForeColor = Color.GreenYellow;
                labelTask12.Text = "Вы успешно решили Этюд №12.";
                MessageBox.Show("Вы успешно решили Этюд №12.", "Обновить Этюд №12", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                labelTask12.ForeColor = Color.WhiteSmoke;
                labelTask12.Text = "Решить за 1 ход не удалось.";
            }
