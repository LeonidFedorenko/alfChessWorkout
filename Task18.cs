...
namespace alfChessWorkout
{
    ...
    {   // картинка из PNG (все фигуры)
        ...
        {   // форма для 18 этюда
            ...
            this.Text = " Этюд №18. Мат в один ход. Ход белых.";
            // загрузка фигур для этюда №18
            Init();
        }

        public void showTask18_click(object sender, EventArgs e)
        {
            if (pictureBox1.Visible == true)
            {
                pictureBox1.Visible = false; // скрываю рисунок (с задачей)
                buttonTask18.Text = "   ОБНОВИТЬ       ДАННЫЙ   ЭТЮД";
            }
            else
            {   // перезапуск этюда
                this.Controls.Clear();
        ...
        {   // кнопка не нажата - фон стандартный
            ...
            if ((userSteps == 1) && (pressedButton.Location.X == 484) && (pressedButton.Location.Y == 174) && (chessboard[2, 5] == 0))
            {
                labelTask18.ForeColor = Color.GreenYellow;
                labelTask18.Text = "Вы успешно решили Этюд №18.";
                MessageBox.Show("Вы успешно решили Этюд №18.", "Обновить Этюд №18", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                labelTask18.ForeColor = Color.WhiteSmoke;
                labelTask18.Text = "Решить за 1 ход не удалось.";
            }
