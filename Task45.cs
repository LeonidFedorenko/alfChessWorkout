...
{
    public partial class Task45 : Form
    {   // картинка из PNG (все фигуры)
        ...
        {   // форма для 45 этюда
            ...
            this.Text = " Этюд №45. Мат в один ход. Ход белых.";
            // загрузка фигур для этюда №45
            Init();
        }

        public void showTask45_click(object sender, EventArgs e)
        {
            if (pictureBox1.Visible == true)
            {
                pictureBox1.Visible = false; // скрываю рисунок (с задачей)
                buttonTask45.Text = "   ОБНОВИТЬ       ДАННЫЙ   ЭТЮД";
            }
            else
            {   // перезапуск этюда
                this.Controls.Clear();
        ...
        {   // кнопка не нажата - фон стандартный
            ...
            if ((userSteps == 1) && (pressedButton.Location.X == 174) && (pressedButton.Location.Y == 112) && (chessboard[5, 1] == 0))
            {
                labelTask45.ForeColor = Color.GreenYellow;
                labelTask45.Text = "Вы успешно решили Этюд №45.";
                MessageBox.Show("Вы успешно решили Этюд №45.", "Обновить Этюд №45", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                labelTask45.ForeColor = Color.OrangeRed;
                labelTask45.Text = "Решить за 1 ход не удалось.";
            }
