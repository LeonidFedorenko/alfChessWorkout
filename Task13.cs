...
namespace alfChessWorkout
{
    ...
    {   // картинка из PNG (все фигуры)
        ...
        {   // форма для 1 этюда
            ...
            this.Text = " Этюд №13. Мат в один ход. Ход черных.";
            // загрузка фигур для этюда №13
            Init();
        }

        public void showTask13_click(object sender, EventArgs e)
        {
            if (pictureBox1.Visible == true)
            {
                pictureBox1.Visible = false; // скрываю рисунок (с задачей)
                buttonTask13.Text = "   ОБНОВИТЬ       ДАННЫЙ   ЭТЮД";
            }
            else
            {   // перезапуск этюда
                this.Controls.Clear();
        ...
        {   // кнопка не нажата - фон стандартный
            ...
            if ((userSteps == 1) && (pressedButton.Location.X == 422) && (pressedButton.Location.Y == 298) && (chessboard[3, 7] == 0))
            {
                labelTask13.ForeColor = Color.GreenYellow;
                labelTask13.Text = "Вы успешно решили Этюд №13.";
                MessageBox.Show("Вы успешно решили Этюд №13.", "Обновить Этюд №13", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                labelTask13.ForeColor = Color.OrangeRed;
                labelTask13.Text = "Решить за 1 ход не удалось.";
            }
