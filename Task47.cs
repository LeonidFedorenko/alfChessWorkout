...
namespace alfChessWorkout
{
    ...
    {   // картинка из PNG (все фигуры)
        ...
        {   // форма для 47 этюда
            ...
            this.Text = " Этюд №47. Мат в один ход. Ход белых.";
            // загрузка фигур для этюда №47
            Init();
        }

        public void showTask47_click(object sender, EventArgs e)
        {
            if (pictureBox1.Visible == true)
            {
                pictureBox1.Visible = false; // скрываю рисунок (с задачей)
                buttonTask47.Text = "   ОБНОВИТЬ       ДАННЫЙ   ЭТЮД";
            }
            else
            {   // перезапуск этюда
                this.Controls.Clear();
        ...
        {   // кнопка не нажата - фон стандартный
            ...
            {
                labelTask47.ForeColor = Color.GreenYellow;
                labelTask47.Text = "Вы успешно решили Этюд №47.";
                MessageBox.Show("Вы успешно решили Этюд №47.", "Обновить Этюд №47", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                labelTask47.ForeColor = Color.OrangeRed;
                labelTask47.Text = "Решить за 1 ход не удалось.";
            }
